...
public class PracticeDemoAPIs {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        WebElement checkbox1 = driver.findElement(By.id("com.touchboarder.android.api.demos:id/check1"));
        checkbox1.click();
        
     //   WebElement checkbox2 = driver.findElement(By.id(""));
        
        WebElement radBtn1 = driver.findElement(By.xpath("//android.widget.RadioButton[@text='RadioButton 1']"));
        radBtn1.click();
